...
func (sc *statsCollection) update(prefix string, info *internal.PrefixInfo) {
	if info.DiskUsage > 0 {
...
func (pu *perItemStats) updateStats(db *pudge.Db, prefix string, item string, info *internal.PrefixInfo) error {
